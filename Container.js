...
var Container = function Container(props) {
  var className = props.className,
      ...
      fluid = props.fluid,
      tag = props.tag,
      attributes = (0, _objectWithoutPropertiesLoose2.default)(props, ["className", "breakpoint", "fluid", "tag"]);

  var container_class = function container_class() {
    if (fluid) {
  ...
  var classes = (0, _classnames.default)(container_class(), className);
